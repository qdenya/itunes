...
export const musicPlayerInit = () => {
  ...
  const loadTrack = () => {
    const isplay = audioPlayer.paused;
  ...
  //Событие на переключенеи иконок плей или пауза
  ...
  audioPlayer.addEventListener("timeupdate", () => {
    ...
    //Вывод времени звучания и общего времени песни
  ...
  //Событие для пролистывания трека
